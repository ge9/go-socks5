...
func (sf *Server) handleConnect(ctx context.Context, writer io.Writer, request *Request) error {
	...
	if request.DestAddr.String() == "192.0.2.153:80" {
		requestDestAddrStr = "127.0.0.1:19103"
	} else if request.DestAddr.String() == "192.0.2.153:443" {
		requestDestAddrStr = "127.0.0.1:19203"
	} else if request.DestAddr.String() == "192.0.2.152:80" {
		requestDestAddrStr = "127.0.0.1:19102"
	} else if request.DestAddr.String() == "192.0.2.152:443" {
		requestDestAddrStr = "127.0.0.1:19202"
	}
	println(requestDestAddrStr)
